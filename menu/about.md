...
* 경력 : 2019.04.01 ~ : 오픈메이트 데이터분석팀 연구원
...
---
> **프로젝트 개요** : 
>> 한국관광공사는 국내 컨벤션 및 이벤트를 참가를 목적으로 내방하는 외국인들의 MICE센터 이용 만족도를 높이기 위해 입/출국 및 관광 패턴을 파악하여 센터와 관광지/공항간의 연계 서비스 제공을 위한 프로젝트를 진행하였습니다. <br/> 프로젝트를 진행하며, MICE센터 이용 외국인의 입출국 및 관광 패턴을 찾기 위하여 KT 통신 데이터를 이용하여 MICE 센터에 체류한 외국인들의 관광 및 입출국 패턴과 사용 교통수단을 판별하고 관광 및 입출국 패턴을 분류하였습니다.
...
---
> **프로젝트 개요**
>> 한국공항공사는 국내 공항을 사용의 편의성을 높이기 위하여 공항별 노선 최적화 및 서비스 개선을 위한 프로젝트를 진행하였습니다. <br/> KT 통신 데이터에서 국내/국제노선을 이용한 내/외국인 수와 공항 도착 전/후 사용 교통 수단을 판별하고 국내 노선 이용 현황을 파악하였습니다.
...
> **담당 업무**
>>관광지 및 축제 지역의 SKT 유동인구 데이터 및 신한카드 매출액 데이터를 프로파일링한 정보를 ggplot, leaflet을 사용하여 시각화 자료하였고, officeR을 사용하여 보고서 자동화를 진행. <br/>경기 그랜드투어에 대한 SKT OD 데이터에 네트워크 알고리즘과 TMAP API를 적용하여 관광 코스를 생성하고 서비스 화면을 구성
...
---
> **프로젝트 개요**
>> 경찰청 범죄 및 교통 데이터와 공공 데이터를 사용하여 위험지역에 대한 <u>효과적인 사고 및 범죄 예방과 출동 시스템을 구축</u>하기 위한 프로젝트를 진행하였습니다. <br/>범죄의 사전 예방과 즉각적일 출동 시스템을 구축하기 위해 방법 시설물과 유흥시설 등 경찰청 빅데이터와 날씨, 주거 인구 등 공공 데이터를 전국 100m x 100m 단위 격자에 녹여 범죄유형별 시간(2시간)단위 예측 모델링 및 시스템을 구축하였습니다.<br/> 또한 교통사고 발생 위험지역 및 정체 구간은 전국 표준노드링크를 기반으로 일, 시간(1시간)단위로 데이터를 생성하여 효과적인 교통 정리를 위한 시스템을 구축하였습니다.
